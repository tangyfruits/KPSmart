...
public class Route implements Event {
	...
	// CONSTRUCTOR
	public Route(Location origin, Location destination, String company, String type, String priority, double weightCost,
			double volumeCost, int maxWeight, int maxVolume, int duration, int frequency, DayOfWeek day, int startTime,
			CustomerPrice customerPrice, LocalDateTime logTime, String user) {
