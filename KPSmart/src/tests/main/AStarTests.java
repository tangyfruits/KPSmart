...
public class AStarTests {
	...
	CustomerPrice cp1 = new CustomerPrice(loc1, loc2, "Land", 1.0, 1.0, LocalDateTime.now(), "User");
	CustomerPrice cp2 = new CustomerPrice(loc1, loc2, "Air", 2.0, 2.0, LocalDateTime.now(), "User");
	CustomerPrice cp3 = new CustomerPrice(loc1, loc3, "Land", 1.0, 1.0, LocalDateTime.now(), "User");
...
//	AStar astarNull = new AStar(null, null);
	...
	CustomerPrice cp10 = new CustomerPrice(loc4, loc5, "Air", 2.0, 2.0, LocalDateTime.now(), "User");
	CustomerPrice cp11 = new CustomerPrice(loc3, loc5, "Land", 1.0, 1.0, LocalDateTime.now(), "User");
	CustomerPrice cp12 = new CustomerPrice(loc3, loc5, "Air", 2.0, 2.0, LocalDateTime.now(), "User");
	CustomerPrice cp13 = new CustomerPrice(loc3, loc4, "Land", 1.0, 1.0, LocalDateTime.now(), "User");
	CustomerPrice cp14 = new CustomerPrice(loc3, loc4, "Air", 2.0, 2.0, LocalDateTime.now(), "User");
