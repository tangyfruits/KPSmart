...
public class LogWriterTest {
	...
	public void writeFile1() {
		...
		Route r1 = new Route(dud, chc, "BopPop Post", "Sea", "Standard", 5, 14, 200, 650, 43, 23, DayOfWeek.MONDAY, 6, c1, LocalDateTime.now(), "donald");
		Route r2 = new Route(chc, dud, "NZ POST man", "Air", "Air", 15, 8, 450, 300, 32, 22, DayOfWeek.TUESDAY, 11, c2, LocalDateTime.now(), "kaszandra");
		Route r3 = new Route(chc, wlg, "NZ POST buh", "Air", "Air", 25, 4, 650, 200, 22, 13, DayOfWeek.THURSDAY, 2, c3, LocalDateTime.now(), "peter");
		Route r4 = new Route(wlg, chc, "Heella Post", "Sea", "Standard", 4, 45, 120, 600, 36, 48, DayOfWeek.WEDNESDAY, 3, c4, LocalDateTime.now(), "pri");
		Route r5 = new Route(wlg, hlz, "NZ POST boy", "Land", "Standard", 42, 6, 200, 300, 25, 41, DayOfWeek.MONDAY, 18, c5, LocalDateTime.now(), "shelley");
		Route r6 = new Route(chc, akl, "BopPop Post", "Sea", "Standard", 457, 2, 220, 300, 15, 5, DayOfWeek.MONDAY, 9, c6, LocalDateTime.now(), "shelley");
		Route r7 = new Route(hlz, akl, "*FreshPost*", "Land", "Standard", 6, 6, 300, 200, 47, 16, DayOfWeek.FRIDAY, 22, c7, LocalDateTime.now(), "pri");
		Route r8 = new Route(akl, wlg, "BopPop Post", "Land", "Standard", 26, 28, 200, 300, 35, 53, DayOfWeek.THURSDAY, 17, c8, LocalDateTime.now(), "kaszandra");
		Route r9 = new Route(akl, dud, "New Ze POST", "Air", "Air", 26, 26, 650, 300, 2, 11, DayOfWeek.MONDAY, 21, c9, LocalDateTime.now(), "donald");
		Route r10 = new Route(akl, bud, "NZ POST bo", "Sea", "Standard", 22, 30, 650, 520, 14, 44, DayOfWeek.WEDNESDAY, 15, c10, LocalDateTime.now(), "donald");
		Route r11 = new Route(akl, la, "BopPop Post", "Air", "Air", 16, 16, 200, 300, 43, 14, DayOfWeek.WEDNESDAY, 8, c11, LocalDateTime.now(), "donald");
		Route r12 = new Route(wlg, akl, "Fresh Post", "Land", "Standard", 37, 23, 390, 300, 2, 24, DayOfWeek.MONDAY, 14, c12, LocalDateTime.now(), "pri");
		Route r13 = new Route(chc, wlg, "Jeff's Van", "Sea", "Standard", 26, 20, 200, 200, 27, 12, DayOfWeek.THURSDAY, 16, c13, LocalDateTime.now(), "peter");
		Route r14 = new Route(chc, dud, "Fresh Post", "Land", "Standard", 18, 6, 650, 210, 15, 24, DayOfWeek.WEDNESDAY, 20, c14, LocalDateTime.now(), "kaszandra");
		Route r15_6 = new Route(chc, akl, "Fresh Post", "Land", "Standard", 16, 3, 200, 580, 10, 7, DayOfWeek.FRIDAY, 7, c6, LocalDateTime.now(), "peter");
		Route r16_14 = new Route(chc, dud, "*FreshPost*", "Sea", "Standard", 25, 14, 200, 550, 24, 11, DayOfWeek.FRIDAY, 5, c14, LocalDateTime.now(), "shelley");
		Route r17_1 = new Route(dud, chc, "Jeff's Van", "Land", "Standard", 25, 3, 300, 540, 10, 10, DayOfWeek.THURSDAY, 5, c1, LocalDateTime.now(), "peter");
		Route r18_9 = new Route(akl, dud, "Jeff's Van", "Air", "Air", 11, 13, 300, 500, 20, 2, DayOfWeek.FRIDAY, 6, c9, LocalDateTime.now(), "sam");
		Route r19_12 = new Route(wlg, akl, "Johnny Mac", "Air", "Air", 25, 9, 420, 320, 3, 12, DayOfWeek.FRIDAY, 3, c12, LocalDateTime.now(), "peter");
		Route r20_13 = new Route(chc, wlg, "Jeff's Van", "Land", "Standard", 22, 5, 450, 320, 16, 6, DayOfWeek.THURSDAY, 7, c13, LocalDateTime.now(), "shelley");
		Route r21_13 = new Route(chc, wlg, "FreshPaste", "Land", "Standard", 37, 6, 240, 390, 6, 4, DayOfWeek.FRIDAY, 8, c13, LocalDateTime.now(), "donald");
