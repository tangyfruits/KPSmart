...
public class LogCustomerPriceUpdateTests {
	...
	public void test1() {
		...
		CustomerPrice price = main.logCustomerPriceUpdate("Wellington",
				"Auckland", "Air", 1.2, 1.4, false,LocalDateTime.now(), "User");
	...
	public void test1a() {
		...
		main.logCustomerPriceUpdate("Wellington", "Auckland", "Air",
				1.2, 1.4, false,LocalDateTime.now(), "User");
	...
	public void test4() {
		...
		main.logCustomerPriceUpdate("Wellington", "Auckland",
				"Standard", 1.2, 1.4, false, LocalDateTime.now(), "User");
	...
	public void test5a() {
		...
		assertEquals(1, main.getLocations().get(0).getPrices().size());
		main.logCustomerPriceUpdate("Wellington", "Auckland", "Air",
				2, 4, false, LocalDateTime.now(), "User");
	...
	public void test7(){
		Main main = new Main();
		CustomerPrice price = main.logCustomerPriceUpdate("Wellington", "Auckland", "Air", 15, 14, false, LocalDateTime.now(), "User");
		main.logTransportCostUpdate("Wellington", "Auckland", "UPS", "Air",
				 3.5, 4.5, 15, 50, 12, 18, DayOfWeek.MONDAY, 12, false, LocalDateTime.now(), "User");
	...
	public void test8(){
		...
		main.logTransportCostUpdate("Wellington", "Auckland", "UPS", "Air",
				3.5, 4.5, 15, 50, 12, 18, DayOfWeek.MONDAY, 13, false, LocalDateTime.now(), "User");
	...
	public void test9(){
		Main main = new Main();
		CustomerPrice price = main.logCustomerPriceUpdate("Wellington", "Auckland", "Standard", 15, 14, false, LocalDateTime.now(), "User");
		main.logTransportCostUpdate("Wellington", "Auckland", "UPS", "Air",
				3.5, 4.5, 15, 50, 12, 18, DayOfWeek.MONDAY,14, false, LocalDateTime.now(), "User");
	}
}